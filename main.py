            ...
            <html>
                <head>
                    ...
                    <style type="text/css">
                        ...
                        .diff-del{background-color:#FF4A4A}
                        .diff-insert-formatting{background-color:#82F67C}
                        .diff-delete-formatting{background-color:#FF4A4A}
                        .mark-diff-insert{background-color:#82F67C}
                        .mark-diff-delete{background-color:#FF4A4A}
                        .mark-diff-insert-formatting{background-color:#82F67C}
                        .mark-diff-delete-formatting{background-color:#FF4A4A}
                    </style>
                </head>
                <body>
